...
public class LearnWebTable {
	...
	public static void main(String[] args) {
		...
		String rowvalue = driver
				.findElement(By.xpath("//div[@class='ui-datatable-scrollable-body']/table/tbody/tr/td[1]")).getText();
		...
		List<WebElement> allcol = driver
				.findElements(By.xpath("//div[@class='ui-datatable-scrollable-body']/table/tbody/tr[1]/td"));
